          ...
          <div className=" w-1/3 p-20">
            <div className="border-2 bg-yellow-400 text-center rounded-md">
              <div className="flex flex-col py-4 px-4 mx-2 items-center text-justify">
                ...
                <p className="w-64">
                  En este apartado en contrara toda su informacion registrada ,
                  la cual puede ser actualizada.Todo cambio es bajo su
                  resposabilidad
                </p>
                <button
          ...
          <div className="w-1/3 p-20">
            <div className="border-2 bg-yellow-400 text-justify rounded-md">
              <div className="flex flex-col py-4 px-4 mx-2 items-center text-justify">
                ...
                <p className="w-64">
                  En este apartado encontrara toda su historia clinico realizada
                  en Labmeta S.A detallando la fecha y hora de cuando fue
                  realizada.
                </p>
                <button
                  className="bg-green-500 lg:text-sm md:text-xl text-sm px-4 py-4 hover:bg-green-500 hover:text-white rounded-lg"
          ...
          <div className="w-1/3 p-20">
            <div className="border-2 bg-yellow-400 text-center rounded-md">
              <div className="flex flex-col py-4 px-4 mx-2 items-center text-justify">
                ...
                <p className="w-64">
                  En este partado puede realizar citas, las cuales se acomoden a
                  su horario donde tambien puede verficar una cita ya reservada.
                </p>
                <button
                  className="bg-green-500 lg:text-sm md:text-xl text-sm px-4 py-4 hover:bg-green-500 hover:text-white rounded-lg"
                  onClick={() => this.props.history.push("/login")}
