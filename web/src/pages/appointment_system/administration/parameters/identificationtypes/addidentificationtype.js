...
class Addidentificationtype extends Component {
  constructor(props) {
    super(props);
    this.state = {
      pers_tip_ide_des: "",
  ...
  saveData = (e) => {
    ...
    if (this.post.datos.pers_tip_ide_des === "") {
      Swal.fire("", "Complete todos los datos para continuar...!");
    } else {
      axios
        .post(API + "persona_tipo_identificacione", this.post)
        .then((response) => {
...
export default withRouter(Addidentificationtype);
