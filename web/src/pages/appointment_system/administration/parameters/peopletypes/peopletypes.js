...
class Peopletypes extends Component {
  constructor(props) {
    super(props);
    this.state = {
      table_header: {
  ...
  updateData = (p_id, p_pers_tip_des) => {
    ...
    this.props.history.push("/admin/parameters/updatepeopletype");
  };
      ...
      if (result.value) {
        ...
        Swal.fire({
          ...
          window.location.assign(
            "http://localhost:3000/admin/parameters/peopletypes"
          )
        );
      }
    });
...
export default withRouter(Peopletypes);
