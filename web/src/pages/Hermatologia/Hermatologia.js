        ...
        return (
            <div className="font-serif">
                ...
                <div className="py-8 lg:px-32 md:px-32 px-8 bg-gray-300 flex flex-col">
                    <h1 className="text-center lg:text-4xl md:text-4xl text-2xl font-bold text-green-700">Hermatología</h1>
                    <p className="text-justify lg:text-2xl md:text-2xl text-md text-green-700">
                        Es la especialidad médica que se ocupa del estudio, diagnóstico, tratamiento y prevención de las
                        enfermedades de la sangre y los órganos que participan en su producción, como son la médula ósea,
                        el bazo o los ganglios, entre otros.
                    </p>
                    <p className="text-justify lg:px-32 py-2 lg:text-xl md:text-xl text-sm">
                        Asimismo , se ocupa de los componentes de la sangre (glóbulos rojos, eritrocitos, plaquetas, leucocitos,
