      ...
      <div className="font-hairline">
        ...
        <div className="py-8 lg:px-32 md:px-32 px-8 bg-gray-300 flex flex-col">
          ...
          <p className="text-justify lg:text-2xl md:text-2xl text-md text-green-700">
            ...
            electromagnéticas. Las imágenes de rayos X muestran el interior de
            su cuerpo en diferentes tonos de blanco y negro. Esto es debido a
            que diferentes tejidos absorben diferentes cantidades de radiación.
          </p>
          <p className="text-justify lg:px-32 py-2 lg:text-xl md:text-xl text-sm">
            {" "}
            El calcio en los huesos absorbe la mayoría de los rayos X, por lo
            que los huesos se ven blancos. La grasa y otros tejidos blandos
            absorben menos, y se ven de color gris. El aire absorbe la menor
            cantidad, por lo que los pulmones se ven negros.
          </p>
          <p className="text-justify lg:px-32 py-2 lg:text-xl md:text-xl text-sm">
            El uso más común de los rayos X es para ver fracturas (huesos
            rotos), pero también se utilizan para otros usos. Por ejemplo, las
