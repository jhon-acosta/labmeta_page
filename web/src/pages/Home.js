    ...
    return(
      <div className="font-serif">
        ...
        <div className="flex flex-col items-center lg:px-24 justify-center py-4 bg-yellow-400">
          ...
          <div className="flex flex-wrap justify-center">
            <div className="flex flex-col py-4 px-4 mx-2 items-center text-center">
              <img alt="pic" src={ image1 } className="lg:h-56 lg:w-56 md:h-56 md:w-56 sm:h-48 sm:w-48 h-32 w-32" />
              <p className="py-2 lg:text-xl md:text-xl text-sm font-bold">Cardiología</p>
            </div>
            <div className="flex flex-col py-4 px-4 mx-2 items-center text-center">
              <img alt="pic" src={ image1 } className="lg:h-56 lg:w-56 md:h-56 md:w-56 sm:h-48 sm:w-48 h-32 w-32" />
              <p className="py-2 lg:text-xl md:text-xl text-sm font-bold">Rayos X</p>
            </div>
            <div className="flex flex-col py-4 px-4 mx-2 items-center text-center">
              <img alt="pic" src={ image1 } className="lg:h-56 lg:w-56 md:h-56 md:w-56 sm:h-48 sm:w-48 h-32 w-32" />
              <p className="py-2 lg:text-xl md:text-xl text-sm font-bold">Ginecología</p>
            </div>
            <div className="flex flex-col py-4 px-4 mx-2 items-center text-center">
              <img alt="pic" src={ image1 } className="lg:h-56 lg:w-56 md:h-56 md:w-56 sm:h-48 sm:w-48 h-32 w-32" />
              <p className="py-2 lg:text-xl md:text-xl text-sm font-bold">Ecografía</p>
            </div>
            <div className="flex flex-col py-4 px-4 mx-2 items-center text-center">
              <img alt="pic" src={ image1 } className="lg:h-56 lg:w-56 md:h-56 md:w-56 sm:h-48 sm:w-48 h-32 w-32" />
              <p className="py-2 lg:text-xl md:text-xl text-sm font-bold">Hermatología</p>
            </div>
          </div>
        </div>
