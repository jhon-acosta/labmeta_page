      ...
      <div className="font-serif">
        ...
        <div className="flex items-center justify-center px-12 py-12">
          ...
          <div className="lg:w-1/2 w-full">
            <h1 className="lg:text-5xl text-3xl font-bold text-green-400">Bienvenido a Labmeta S.A.</h1>
        ...
        <div className="flex bg-white h-auto">
          <div className="flex flex-col self-center items-center text-center lg:text-left px-8 md:px-12 lg:w-1/2">
            <div className="py-4">
              <h2 className="text-3xl text-gray-800 md:text-4xl font-bold">¿Quíenes Somos?.</h2>
            ...
            <div className="py-4">
              <h2 className="text-3xl text-gray-800 md:text-4xl font-bold">Filosofía.</h2>
            ...
            <div className="py-4">
              <h2 className="text-3xl text-gray-800 md:text-4xl font-bold">Calidad del Servicio.</h2>
