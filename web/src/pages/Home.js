      ...
      <div className="font-serif">
        ...
        <div className="flex items-center justify-center px-12 py-12">
          ...
          <div className="lg:w-1/2 w-full">
            <h1 className="lg:text-4xl text-3xl font-bold text-green-400">Bienvenido a Labmeta S.A.</h1>
        ...
        <div className="flex flex-col h-auto items-center lg:px-24 px-8 justify-center py-12 bg-green-400">
          <h1 className="lg:text-3xl text-2xl text-center font-bold">¿Por qué escojer a Labmeta S.A.?</h1>
        ...
        {/* <div className="flex bg-white h-auto">
          <div className="flex flex-col self-center items-center text-center lg:text-left px-8 md:px-12 lg:w-1/2">
            <div className="py-4">
              <h2 className="text-2xl text-gray-800 lg:text-3xl font-bold">¿Quiénes Somos?.</h2>
              <p className="mt-2 text-sm md:text-base text-justify">Somos una institución de salud privada, con sentido social que apoya al sector empresarial
            ...
            <div className="py-4">
              <h2 className="text-2xl text-gray-800 md:text-3xl font-bold">Filosofía.</h2>
              <p className="mt-2 text-sm md:text-base text-justify">Nuestra filosofía de trabajo es la satisfacción del cliente, a través del cumplimiento de los
            ...
            <div className="py-4">
              <h2 className="text-2xl text-gray-800 md:text-3xl font-bold">Calidad del Servicio.</h2>
              <p className="mt-2 text-sm md:text-base text-justify">Todos son exámenes realizados por profesionales y especialistas en Salud Ocupacional con
