...
class Ecografia extends Component {
    render() {
        const ecografia_img = require("./ecografia_img.jpg")
        return (
            <div className="font-serif">
                <Header />
                <div className="py-8 lg:px-32 md:px-32 px-8 bg-gray-300 flex flex-col">
                    <h1 className="text-center lg:text-4xl md:text-4xl text-2xl font-bold text-green-700">Ecografía</h1>
                    <p className="text-justify lg:text-2xl md:text-2xl text-md text-green-700">
                        La ecografía o ultrasonido es un tipo de imagen. Utiliza ondas sonoras de
                    ...
                    <p className="text-justify lg:px-32 py-2 lg:text-xl md:text-xl text-sm">
                        Los profesionales de la salud los usan para ver el corazón, los vasos sanguíneos,
                        los riñones, el hígado y otros órganos.
                    </p>
                    <p className="text-justify lg:px-32 py-2 lg:text-xl md:text-xl text-sm">
                        Durante el embarazo, los médicos usan las pruebas con ultrasonido para observar
                        al feto. A diferencia de las radiografías, la ecografía no expone a la radiación.
                    </p>
                    <img src={ecografia_img} alt="pic" className="py-2" />
                    ...
                    <p className="text-center text-green-700 text-2xl font-bold py-2">COSTO DEL SERVICIO : $ 74.99</p>
                </div>
                <Footer />
            </div>
        )
